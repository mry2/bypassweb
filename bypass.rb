...
puts "Tools untuk mengidentifikasi IP asli dari situs web yang dilindungi CloudFlare"
puts "https://github.com/mry2"
...
if options[:bypass].nil?
    puts "ruby bypass.rb Masukkan URL -b atau --byp"
else
	begin
